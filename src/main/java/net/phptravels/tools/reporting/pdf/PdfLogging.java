...
public class PdfLogging implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		try {
			...
			pdfG.generatePDF(successTable, p, method.getMethodName(), PdfLog.getStepLog(),
					hostName, exedate, methodDes, suiteName, "Passed");
...
//					hostName, exedate, methodDes, suiteName, PdfLog.getStatusList(), "Failed");
			pdfG.generatePDF(failTable, p, method.getMethodName(), PdfLog.getStepLog(),
					hostName, exedate, methodDes, suiteName, "Passed");
		} catch (FileNotFoundException e) {
...
//					hostName, exedate, methodDes, suiteName, PdfLog.getStatusList(), "Skipped");
			pdfG.generatePDF(skippTable, p, method.getMethodName(), PdfLog.getStepLog(),
					hostName, exedate, methodDes, suiteName, "Passed");
		} catch (FileNotFoundException e) {
