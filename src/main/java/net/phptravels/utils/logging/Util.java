...
import net.phptravels.data.constants.Constants;
...
/**
 * Contains auxiliary/utility methods.
 * TODO: generalize string-date/ date-string converters (extract common, support locales etc).
 */
public class Util {
